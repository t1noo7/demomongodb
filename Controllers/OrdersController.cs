...
namespace DemoMongoDB.Controllers
{
    public class OrdersController : Controller
    {
        ...
        private readonly IMongoCollection<Courses> _coursesCollection; // Assuming Course model is also used
        ...
        public IActionResult Checkout()
        {
            ...
            int totalAmount = cartItems.Sum(item => item.Quantity * item.courses.Price);
